...
**Project**: crypto-capture-hub 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a crypto app, use the coincap API 
...
```sh
git clone https://github.com/GPT-Engineer-App/crypto-capture-hub.git
cd crypto-capture-hub
npm i
